...
namespace BCGov.WaitingQueue.Admin.Server.ErrorHandling
{
    using System.Net;
    ...
    public static class ExceptionUtility
    {
        ...
        public static ProblemDetails CreateValidationError(string memberName, string details) =>
            CreateProblemDetails(details, StatusCodes.Status400BadRequest, "Validation", memberName);
        ...
        public static ProblemDetails CreateNotFoundError(string details) =>
            CreateProblemDetails(details, StatusCodes.Status404NotFound, "NotFound");
    }
}
