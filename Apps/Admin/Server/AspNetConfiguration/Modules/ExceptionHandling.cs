...
namespace BCGov.WaitingQueue.Admin.Server.AspNetConfiguration.Modules
{
    ...
    using ProblemDetailsException = BCGov.WaitingQueue.Admin.Server.ErrorHandling.ProblemDetailsException;
                ...
                setup =>
                {
                    ...
                    setup.Map<ProblemDetailsException>(
                        exception => new ProblemDetails
                        {
                            ...
                            Status = exception.ProblemDetails?.Status ?? StatusCodes.Status500InternalServerError,
