...
// -------------------------------------------------------------------------
namespace BCGov.WaitingQueue.Admin.Client.Components.Common
{
    ...
    /// </summary>
    public partial class WqaRichTextEditor : ComponentBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WqaRichTextEditor"/> class.
        /// </summary>
        public WqaRichTextEditor()
        {
