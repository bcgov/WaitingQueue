...
//-------------------------------------------------------------------------
namespace BCGov.WaitingQueue.Admin.Client.Theme
{
    using MudBlazor;

    /// <summary>
    /// Provides shared settings for the Waiting Queue Admin themes.
    /// </summary>
    public class WgaTheme : MudTheme
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WgaTheme"/> class.
        /// </summary>
        public WgaTheme()
        {
